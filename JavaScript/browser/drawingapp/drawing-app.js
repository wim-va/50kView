...
// TODO: maak decl van var verplicht

// TODO: maak een ctor Point.
// een Point-object heeft een x-coordinaat (int), een y-coordinaat (int),
// een kleur (string), een tool (string), een grootte (int), en een veld dragging van type boolean
...
// TODO: Gebruik jQuery om ervoor te zorgen dat functie prepareCanvas opgeroepen wordt
// als de DOM-tree geladen is
...
function prepareCanvas() {
	// TODO:  zoek het element met id canvas op in de DOM-tree en 
	// ken dit toe aan globale var canvas
	// ken waarde canvaswidth toe als width
	// ken waarde canvasHeight toe als height
	
	// TODO: ken aan globale var context de context van het canvas element toe
...
function addMouseEvents() {
	...
	// TODO:  als de muiscursor het canvas element verlaat, 
	// moet niet meer getekend worden.
	// Voeg hiervoor een eventhandler toe waarin globale var paint
	// waarde false krijgt
}
...
function addClick(x, y, dragging) {
	// TODO: voeg een nieuw Point-object met de opgegeven x,y en dragging 
	// toe aan de globale array met Point-objecten.
	// De kleur van het Point-object moet de kleur zijn die momenteel geselecteerd is ("current Color").
	// De tool van het Point-object moet de tool zijn die momenteel geselecteerd is ("current Tool").	
	// De grootte van het Point-object moet de grootte zijn die momenteel geselecteerd is ("current Size").
}

/**
 * Clears the canvas.
 */
// TODO: voeg functie clearCanvas toe
